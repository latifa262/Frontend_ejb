...
export class QuartierService {
    ...
    private url = environment.baseUrl + 'quartiers';
    private _items: Array<Quartier>;
    private _selected: Quartier;
    private _selectes: Array<Quartier>;
    ...
    public findAll(): Observable<Array<Quartier>> {
        console.log("entred to findAll");
        return this.http.get<Array<Quartier>>(this.url);
    }

    public save(): Observable<Quartier> {
        return this.http.post<Quartier>(this.url, this.selected);
    }

    public edit(): Observable<Quartier> {
        return this.http.put<Quartier>(this.url + '/' + this.selected.id, this.selected);
    }
