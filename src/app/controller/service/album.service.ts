...
export class AlbumService {
    ...
    private url = environment.baseUrl + 'albums';
    private _items: Array<Album>;
    private _selected: Album;
    private _selectes: Array<Album>;
    ...
    public findAll(): Observable<Array<Album>> {
        console.log("entred to findAll");
        return this.http.get<Array<Album>>(this.url);
    }

    public save(): Observable<Album> {
        return this.http.post<Album>(this.url, this.selected);
    }

    public edit(): Observable<Album> {
        return this.http.put<Album>(this.url + '/' + this.selected.id, this.selected);
    }
